...
import { getChannelDetail, getComment, getComments, getVideoDetail } from "./action";
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="min-h-screen col-span-2 bg-gradient-to-br from-main-pink">
          {isLoading ? (
            ...
            <div className="grid grid-cols-3 border-2 border-black mt-16 ml-12 mr-24 rounded-md p-4 bg-white/30 backdrop-blur-md w-[75%]">
